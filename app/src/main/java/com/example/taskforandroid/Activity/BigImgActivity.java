...
public class BigImgActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thisImageUrl = getIntent().getStringExtra("thisImageUrl");
        ...
        mPager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, final int position) {
                if (ImageUrls[position] != null && !"".equals(ImageUrls[position])) {
                    final PhotoView view = new PhotoView(BigImgActivity.this);
                    view.enable();
                    view.setScaleType(ImageView.ScaleType.FIT_CENTER);
                    Glide.with(BigImgActivity.this).load(ImageUrls[position]).override(Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL).fitCenter().crossFade().listener(new RequestListener<String, GlideDrawable>() {
    ...
    private int returnClickedPosition() {
        if (ImageUrls == null || thisImageUrl == null) {
            return -1;
        }
        for (int i = 0; i < ImageUrls.length; i++) {
            if (thisImageUrl.equals(ImageUrls[i])) {
                return i;
            }
        }
        return -1;
    ...
    private void showLoadingAnimation() {
        ...
        centerIv.setImageResource(R.drawable.dialog_loading_img);
    ...
    private void showErrorLoading() {
        centerIv.setVisibility(View.VISIBLE);
        releaseResource();
        centerIv.setImageResource(R.drawable.ic_launcher_background);
    }
