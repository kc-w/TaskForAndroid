...
//插入音频
RE.insertAudio = function(url,style) {
    var html = '&nbsp;<audio controls="controls" src="' + url + '" style="' + style + '"></audio>&nbsp;</br></br>';
    RE.insertHTML(html);
    RE.editor.scrollIntoView(false)
}

//插入视频
RE.insertVideo = function(url,style,posterUrl) {
    var html = '&nbsp;<video height="300" controls="controls" initial-time="0.01" poster="' +posterUrl+ '" src="' + url + '" style="' + style + '"></video>&nbsp;</br></br>';
    RE.insertHTML(html);
    RE.editor.scrollIntoView(false)
}
